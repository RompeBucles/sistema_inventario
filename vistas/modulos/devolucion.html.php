      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="nuevoProducto">
        ...
        <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevaDescripcion" placeholder="Ingresar descripción" required>
                 ...
                 <!-- ENTRADA PARA SELECCIONAR ESTADO DEL PRODUCTO -->
            ...
            <div class="col-xs-6">
              ...
              <div class="input-group">
                  ...
                  <input type="number" class="form-control input-lg" name="nuevoReembolso" min="0" placeholder="Reembolso" required>
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <img src="vistas/img/devolucion/default/anonymous.png" class="img-thumbnail" width="100px">
