          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="editarNombre" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ' ']{2,30}"  name="editarNombre" value="" required>
            ...
            <!-- ENTRADA PARA LA CONTRASEÑA -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="password" class="form-control input-lg"  name="editarPassword" placeholder="Ingresar contraseña" pattern="[A-Za-z][A-Za-z0-9]{5,10}" title="La contraseña debe empezar con una letra y contener dígitos, con una longitud de 10 carácteres, no debe contener símbolos" >
