...
class ControladorVentas{
	...
	static public function ctrEditarVenta(){
		...
		if(isset($_POST["editarVenta"])){
			...
			swal({
				  type: "error",
				  title: "La devolución no fue realizada, si no hay productos",
				  showConfirmButton: true,
				  confirmButtonText: "Cerrar"
				  }).then(function(result){
							if (result.value) {
			...
			$datos = array("id_vendedor"=>$_POST["idVendedor"],
						   ...
						   "dproductos"=>$listaProductos,
						   
						   "reembolso"=>$_POST["totalVenta"]);
						   

			$respuestas = ModeloVentas::mdlEditarVenta($tabla, $datos);
	...
	public function ctrSumaTotalVenta(){

		$tabla = "ventas";

		$respuestas = ModeloVentas::mdlSumaTotalVenta($tabla);
