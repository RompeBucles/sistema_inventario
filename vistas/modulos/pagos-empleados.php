...
<div class="content-wrapper">
  ...
  <section class="content-header"> 
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"> Gestión pagos a empleados</li>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <a href="reporte-empleados" class="btn btn-success">Reporte pagos a empleados</a>
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" id="nuevoEmpleado" name="nuevoEmpleado" required>
                  ...
                  foreach ($empleado as $key => $value) {
                    ...
                    echo '<option value="'.$value["id"].'">'.$value["empleado"].'</option>';
                  }
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg"  name="editarEmpleado" readonly required>
                  
                  <option id="editarEmpleado"></option>
